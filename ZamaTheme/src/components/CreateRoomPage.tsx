...
import { ArrowLeft, Plus, X, Upload, Users, Clock, Shield, Copy, Check, Lock } from 'lucide-react';
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="bg-gray-800/50 border-gray-700/50">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl text-white">Room Created Successfully!</CardTitle>
              ...
              <CardContent className="space-y-6">
                <div className="bg-gray-700/50 rounded-lg p-4 text-center">
                  ...
                  <p className="text-sm text-gray-500 mt-2">Share this code for others to join</p>
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-400">Set up a secure voting session with FHE technology</p>
            </div>
          </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Require a password to join this room</p>
                      </div>
                      <Switch
                        checked={hasPassword}
              ...
              <Card className="bg-gray-800/50 border-gray-700/50">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-gray-700/30 rounded-lg p-3 text-center">
                    ...
                    <div className="text-sm text-gray-400">Valid Candidates</div>
                  </div>
                </CardContent>
              </Card>
