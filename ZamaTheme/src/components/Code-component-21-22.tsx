    ...
    const mockCandidates: Candidate[] = [
      {
        id: '1',
        name: 'Nguyễn Minh An',
        description: '5 năm kinh nghiệm marketing, chuyên gia digital',
      ...
      },
      {
        id: '2', 
        name: 'Trần Thị Bảo',
        description: 'Chuyên gia content marketing và social media',
      ...
      },
      {
        id: '3',
        name: 'Lê Hoàng Nam',
        description: 'Kinh nghiệm quản lý team và phát triển chiến lược',
    ...
    return (
      <div className="min-h-screen bg-[#0F0F23] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Đang tải phòng bỏ phiếu...</p>
        </div>
      </div>
    );
  }
              ...
              <div className="grid md:grid-cols-4 gap-4 mb-8">
                ...
                <Card className="bg-gray-800/50 border-gray-700/50">
                  <CardContent className="p-4 text-center">
                    ...
                    <div className="text-sm text-gray-400">Người tham gia</div>
                  </CardContent>
                </Card>
              ...
              <Card className="bg-gray-800/50 border-gray-700/50 mb-8">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-400">Tiến độ bỏ phiếu</span>
                ...
                <Card className="bg-green-500/10 border-green-500/30 mb-8">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-green-400">Bạn đã bỏ phiếu thành công!</div>
                        <div className="text-sm text-green-300/70">Phiếu của bạn đã được mã hóa và ghi nhận an toàn</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
